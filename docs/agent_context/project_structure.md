...
- `docs/agent_context/nornikel_e5_db_storage_ownership.md` — E5 Databases: product events storage, export/audit/notification indexes, retention notes.
- `docs/agent_context/nornikel_e6_db_seed_report.md` — E6 Databases: repeatable seed/reset gate, counts report, Makefile targets.
