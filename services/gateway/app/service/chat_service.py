...
class ChatService:
    def __init__(self, repository: ChatRepository, gateway_service: GatewayService) -> None:
    ...
    async def send_message(
        ...
        assistant_payload = self._map_query_response(query_response)
    ...
    @classmethod
    def _map_query_response(cls, query_response: dict) -> dict:
