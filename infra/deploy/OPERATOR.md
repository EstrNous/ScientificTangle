...
Одна команда: Docker, стек, пользователи, скачивание полного корпуса (если нет на диске) и batch-индексация (если ещё не проиндексировано). Без корпуса: `--skip-corpus`. Маленький demo: `--with-demo`.
...
Полный корпус поднимается автоматически в `cloud_deploy.sh` (без `--skip-corpus`):
скачивание с Яндекс.Диска при отсутствии файлов на диске, batch-ингestion с `--resume`, пропуск если уже проиндексировано.

Ручной запуск (если нужен отдельно):
