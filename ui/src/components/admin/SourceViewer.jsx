...
export default function SourceViewer({ span }) {
  ...
  if (!span) {
    return (
      <div className="nn-card flex h-full min-h-[140px] items-center justify-center p-4 text-sm text-nn-gray dark:text-slate-400">
        {t('admin.sourceEmpty')}
      </div>
    );
  }
  ...
  return (
    <div className="nn-card p-4">
      ...
      <p className="text-sm font-semibold text-gray-900 dark:text-slate-100">{span.title}</p>
